...
- 商业数字人 SDK、真人级骨骼绑定和外部 AI 图生 3D 高保真初模仍是 P1；当前已完成 realistic-3d 渲染器、本地 Blender 全身演示 GLB、local-2d 高清 mouth sprites + viseme 时间线口型同步兜底，并提供 OBJ/OpenSCAD/Blender 脚本资产链路。
